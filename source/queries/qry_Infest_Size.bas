dbMemo "SQL" ="SELECT DISTINCT qry_Infest_Size_Select.*, qry_Annual_Complete_Tgt_Species_Lists."
    ...
    "ecies_Lists ON (qry_Infest_Size_Select.Master_Code = qry_Annual_Complete_Tgt_Spe"
    "cies_Lists.Master_Plant_Code_FK) AND (qry_Infest_Size_Select.Visit_Year = qry_An"
    "nual_Complete_Tgt_Species_Lists.TgtYear) AND (qry_Infest_Size_Select.Unit_Code ="
    " qry_Annual_Complete_Tgt_Species_Lists.Park)\015\012WHERE (((qry_Infest_Size_Sel"
