dbMemo "SQL" ="INSERT INTO tsys_Link_dbs ( Link_db, Server, File_path, Is_ODBC, Backups )\015\012"
    ...
    "Path, qsys_Linked_tables_not_in_tsys_Link_Tables.ODBC, Not ([ODBC]) AS Backup\015"
    "\012FROM qsys_Linked_tables_not_in_tsys_Link_Tables LEFT JOIN tsys_Link_Dbs ON q"
    "sys_Linked_tables_not_in_tsys_Link_Tables.CurrDb = tsys_Link_Dbs.Link_db\015\012"
    "WHERE (((tsys_Link_Dbs.Link_db) Is Null))\015\012GROUP BY qsys_Linked_tables_not"
...
dbBinary "GUID" = Begin
    0x2d3b378ba706514bb95bdb841bb5657a
End
