dbMemo "SQL" ="SELECT (l.Plot_ID  & \"_\" & t.Transect) AS ID, l.Unit_Code, Year([Start_Date]) "
    "AS Visit_Year, l.Location_ID, l.Plot_ID AS Route, t.Transect_ID, t.Transect, l.A"
    "rea, t.E_Coord, t.N_Coord, q.ID AS Quadrat_ID, q.Quadrat, q.IsSampled, q.NoExoti"
    "cs\015\012FROM ((tbl_Locations AS l LEFT JOIN tbl_Events AS e ON e.Location_ID ="
    " l.Location_ID) LEFT JOIN Transect AS t ON t.Event_ID = e.Event_ID) LEFT JOIN Qu"
    "adrat AS q ON q.Transect_ID = t.Transect_ID\015\012ORDER BY l.Plot_ID, t.Transec"
    "t;\015\012"
dbMemo "Connect" =""
dbBoolean "ReturnsRecords" ="-1"
dbInteger "ODBCTimeout" ="60"
dbMemo "Filter" ="(([Query8].[Unit_Code]=\"GOSP\"))"
