dbMemo "SQL" ="SELECT DISTINCT ts.Unit_Code, ts.Visit_Year, ts.Route, ts.Transect_ID, ts.Transe"
    ...
    "FROM Transect_Select_SpeciesCover AS ts\015\012ORDER BY ts.Unit_Code, ts.Visit_Y"
    "ear, ts.Route, ts.Transect_ID, ts.Transect, ts.Area, ts.E_Coord, ts.N_Coord, ts."
    "Quadrat;\015\012"
dbMemo "Connect" =""
