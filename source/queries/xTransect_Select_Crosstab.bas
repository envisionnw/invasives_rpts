dbMemo "SQL" ="TRANSFORM Min(ts.PercentCover) AS MinOfPercentCover\015\012SELECT ts.Route, ts.T"
    "ransect, ts.Species, ts.IsDead\015\012FROM Transect_Select AS ts\015\012GROUP BY"
    " ts.Route, ts.Transect, ts.Species, ts.IsDead\015\012PIVOT ts.ColName;\015\012"
dbMemo "Connect" =""
