dbMemo "SQL" ="SELECT d.Unit_Code, d.Visit_Year, d.Route, d.Species, MIN(d.Master_Common_Name) "
    ...
    "quared, MIN(d.StdDeviation) AS StdDeviation, MIN(IIF(d.TransectsSampled = 0, NUL"
    "L, IIF(ISNULL(d.StdDeviation) = False,d.StdDeviation/SQR(d.TransectsSampled),NUL"
    "L  ))) AS StdError\015\012FROM Route_StdDeviation AS d\015\012GROUP BY d.Unit_Co"
    "de, d.Visit_Year, d.Route, d.Species, d.IsDead\015\012ORDER BY d.Unit_Code, d.Vi"
    "sit_Year, d.Route, d.Species, d.IsDead;\015\012"
dbMemo "Connect" =""
