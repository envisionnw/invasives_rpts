dbMemo "SQL" ="SELECT ts.Unit_Code, ts.Visit_Year, ts.Route, ts.PlantCode, ts.IsDead, SUM(ts.Pe"
    "rcentCover) AS TotalCover\015\012FROM Transect_Select_LIMITED_ESP_SpeciesCover_S"
    "pecies AS ts\015\012GROUP BY ts.Unit_Code, ts.Visit_Year, ts.Route, ts.PlantCode"
    ", ts.IsDead\015\012ORDER BY ts.Unit_Code, ts.Visit_Year, ts.Route, ts.PlantCode,"
    " ts.IsDead;\015\012"
dbMemo "Connect" =""
